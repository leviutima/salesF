...
import brasao from '../../assets/images/core-values-portuguese.png'
        ...
        <>
            <Layout>
                ...
                <SectionGridImgRightSmall>
                    ...
                    <ProductImage>
                        <img src={brasao} alt="Brasão com a lista de valores da empresa: confiança, sucesso do cliente, inovação, igualdade, sustentabilidade" />
                    </ProductImage>
                </SectionGridImgRightSmall>
            </Layout>
        </>
